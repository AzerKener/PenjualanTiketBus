        ...
        <div class="p-6 sm:p-10">
            ...
            <div class="mt-10 pt-6 border-t border-slate-100">
                <p class="text-sm text-slate-500">
                    <span class="font-semibold text-slate-700">Catatan:</span> Saat ini profil bersifat hanya-baca (read-only). Jika ada perubahan data, silakan hubungi tim dukungan kami.
                </p>
            </div>
        </div>
    </div>
