    ...
    <div class="flex items-center gap-3">
        ...
        <div>
            ...
            <p class="text-sm text-slate-500 mt-0.5">
                Perbarui jadwal
                <span class="font-semibold text-slate-700">{{ $jadwal->rute->asal ?? '' }} → {{ $jadwal->rute->tujuan ?? '' }}</span>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                ...
                <div>
                    ...
                    <input type="time"
                           ...
                           value="{{ old('waktu_berangkat', \Carbon\Carbon::parse($jadwal->waktu_berangkat)->format('H:i')) }}"
